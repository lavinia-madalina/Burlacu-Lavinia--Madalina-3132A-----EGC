...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private string fileVertex = locatieSolutie + "vertexList.txt";
        private string fileQList = locatieSolutie+"quadsVertexList.txt";
        private string fileTList = locatieSolutie+"trianglesVertexList.txt";
